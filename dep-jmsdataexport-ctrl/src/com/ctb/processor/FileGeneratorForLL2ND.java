...
public class FileGeneratorForLL2ND {
	...
	private void setEthnicity(Set<StudentDemographic> sd, TfilLL2ND tfil) {
		...
		if("1".equalsIgnoreCase(tfil.getEthinicity1())){
