...
<h1>Users</h1>
<ul>
    <li><a href="/UserManagementWeb/manageUser/beginAddUser.do" onclick="return verifyExitEditTest();"><span>Add User</span></a></li>
    <li><a href="/UserManagementWeb/manageUser/beginFindUser.do" onclick="return verifyExitEditTest();"><span>Find User</span></a></li>
</ul>
</ctb:auth>
...
<h1>Organizations</h1>
<ul>
    <li><a href="/OrganizationManagementWeb/manageOrganization/beginAddOrganization.do" onclick="return verifyExitEditTest();"><span>Add Organization</span></a></li>
    <li><a href="/OrganizationManagementWeb/manageOrganization/beginFindOrganization.do" onclick="return verifyExitEditTest();"><span>Find Organization</span></a></li>
</ul>
</ctb:auth>
...
<h1>Tests</h1>
<ul>
    <li><a href="/OrganizationManagementWeb/manageCustomerService/CustomerServiceManagementController.jpf" onclick="return verifyExitEditTest();"><span>Reset Test Session</span></a></li>
</ul>
</ctb:auth>
...
<ctb:auth roles="Administrator, Administrative Coordinator, Coordinator, Proctor">
	...
	<ul>
        ...
        <li><a href="/HandScoringWeb/studentScoringPageFlow/beginIndivStudentScoring.do" onclick="return verifyExitEditTest();" ><span>Student Scoring</span></a></li>
...
<ul>
    <li><a href="/TestSessionInfoWeb/downloadclient/DownloadClientController.jpf" onclick="return verifyExitEditTest();"><span>Install Software</span></a></li>
    <li><a href="/TestSessionInfoWeb/downloadtest/DownloadTestController.jpf" onclick="return verifyExitEditTest();"><span>Download Test</span></a></li>
</ul>
</ctb:auth>
...
<h1>Reports</h1>
<ul>
    <li><a href="/DataExportWeb/dataExportPageFlow/begin.do" onclick="return verifyExitEditTest();"><span>Data Export</span></a></li>
    <li><a href="/DataExportWeb/dataExportPageFlow/beginViewStatus.do" onclick="return verifyExitEditTest();"><span>View Status</span></a></li>
