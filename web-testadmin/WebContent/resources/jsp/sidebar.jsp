...
<ctb:auth roles="Administrator, Administrative Coordinator, Coordinator">
    ...
    <ul>
        ...
        <c:if test="${ !requestScope.isSelectTest }">    
            <li><a href="/TestAdministrationWeb/scheduleTestPageflow/ScheduleTestController.jpf" onclick="return verifyExitScheduleTest();"><span>Schedule Test Session</span></a></li>
        </c:if>
