...
public interface CustomerServiceManagement {
	...
	com.ctb.bean.testAdmin.StudentSessionStatusData getSubtestListForStudent(java.lang.Integer rosterId, String testAccessCode, FilterParams filter, PageParams page, SortParams sort) throws CTBBusinessException;
