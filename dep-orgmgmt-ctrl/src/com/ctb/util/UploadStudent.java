    ...
    public void run () {
        ...
        try {
         ...
         //create Student and organization
           createOrganizationAndStudent (requiredMap, maxLengthMap, 
                                            invalidCharMap, logicalErrorMap, 
 ...
 */
   ...
   */ 
    private void errorExcelCreation (HashMap requiredMap,  
                ...
                HashMap logicalErrorMap, HashMap hierarchyErrorMap, HashMap leafNodeErrorMap ) {
   ...
   */ 
    private void getEachRowStudentDetail(int rowPosition,HSSFRow row, HSSFRow rowHeader, 
            ...
            HashMap invalidCharMap, HashMap logicalErrorMap) throws Exception {
