...
<input type="hidden" id="oosToggleSuccess" name="oosToggleSuccess" value=<lb:label key="stu.msg.oosToggled" prefix="'" suffix="'"/>/>
<input type="hidden" id="oosID" name="oosID" value=<lb:label key="stu.label.outOfSchool" prefix="'" suffix="'"/>/>
<input type="hidden" id="oosFailed" name="oosFailed" value=<lb:label key="stu.msg.oosToggledFailed" prefix="'" suffix="'"/>/>
...
$(document).ready(function(){
	setMenuActive("organizations", "OOSLink");
});
</script>
