  ...
  function setBulkMessageMain(title, content, type, message){
	...
	function createDemoList(){
		var liMenuStr = "<div><ul class='sf-menu' id='menu'>";
		 for (var i=0; i<3; i++) {
		 	liMenuStr = liMenuStr + "<li class='selected'><a href='#' class='menuText roundedBorder' id='selectedBox"+parseInt(i+1)+"'>Please select</a><ul><li><a href='#' id='ps_"+parseInt(i+1)+"'>Please select</a>";
