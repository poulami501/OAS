...
<netui:html>
  <head>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/autosuggest.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/studentsuggestions.js"></script>         
  </head>

<c:if test="${selectedModule == 'moduleStudentProfile'}">       
  <body onload="initStudentSuggestions(); setFocusFirstElement();">
</c:if> 
