...
<netui-template:setAttribute name="title" value="${bundle.web['bulkStudentsMove.window.title']}"/>
<netui-template:setAttribute name="helpLink" value="${bundle.help['help.topic.bulkStudentsMove']}"/>
...
<input type="hidden" id="moveStuDialogTitle" name="moveStuDialogTitle" value=<lb:label key="stu.label.moveStuDialogTitle" prefix="'" suffix="'"/>/>
