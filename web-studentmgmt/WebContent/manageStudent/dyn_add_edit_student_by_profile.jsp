...
<!-- Student Information -->
<td class="simple" width="400">


<table class="transparent">
    <tr class="transparent">
        <td class="transparent alignRight" width="210"><span class="asterisk">*</span>&nbsp;<netui:content value="First Name:"/></td>
    ...
    <tr class="transparent">
        <td class="transparent alignRight" width="210"><netui:content value="Middle Name:"/></td>
        <td class="transparent">
        <c:if test="${ profileEditable }">            
    ...
    <tr class="transparent">
        <td class="transparent alignRight" width="210"><span class="asterisk">*</span>&nbsp;<netui:content value="Last Name:"/></td>
        <td class="transparent">
        <c:if test="${ profileEditable }">   
         <!-- Added tagId to resolve javascript isssue occured in mozilla  for webLogic 10.3-->             
    ...
    <tr class="transparent">
        <td class="transparent alignRight" width="210">
    ...
    <tr class="transparent" >
        <td class="transparent alignRight" width="210"><span class="asterisk">*</span>&nbsp;<netui:content value="Grade:"/></td>
        <td class="transparent">
        <c:if test="${ profileEditable }">            
    ...
    <tr class="transparent">
        <td class="transparent alignRight" width="210"><span class="asterisk">*</span>&nbsp;<netui:content value="Gender:"/></td>
        <td class="transparent">
        <c:if test="${ profileEditable }">            
     ...
     <tr class="transparent">
        <td class="transparent alignRight" width="210"><span class="asterisk">*</span>&nbsp;<netui:content value="Instructor First Name:"/></td>
        <td class="transparent"><input type="text" maxlength="64" style="width:180px"/></td>
    </tr>
       <tr class="transparent">
        <td class="transparent alignRight" width="210"><span class="asterisk">*</span>&nbsp;<netui:content value="Instructor Last Name:"/></td>
        <td class="transparent"><input type="text" maxlength="64" style="width:180px"/></td>
    </tr>
     <tr class="transparent">
        <td class="transparent alignRight" width="210"><span class="asterisk">*</span>&nbsp;<netui:content value="Social Security Number/Student ID :"/></td>
         <td class="transparent"><input type="text"  maxlength="64" style="width:180px"/></td>
    </tr>
     <tr class="transparent">
     ...
     <tr class="transparent">
        <td class="transparent alignRight" width="210"><span class="asterisk">*</span>&nbsp;<netui:content value="Is PBA Consent form signed:"/></td>
        <td class="transparent-small" width="200">
	        <input type="radio" value="Yes" checked="true"/>&nbsp;&nbsp;&nbsp;Yes
	        <input type="radio" value="No"/>&nbsp;&nbsp;&nbsp;No
        </td>
    ...
    <tr class="transparent">
        <td class="transparent-top alignRight" width="210"><span class="asterisk">*</span>&nbsp;<netui:content value="Organization:"/></td>
