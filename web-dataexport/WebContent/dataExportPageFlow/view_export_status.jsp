...
<netui-template:template templatePage="/resources/jsp/view_status_template.jsp">
	<!-- 
	...
	<netui-template:section name="bodySection">
		...
		<netui:form action="getExportStatus">
			...
			<p><netui:content value="${pageFlow.pageMessage}" /></p>
				<p><netui:hidden dataSource="actionForm.jobMaxPage" /> <!--  jobList table -->
				...
				<netui:button type="submit" value="${bundle.web['common.button.home']}" action="goto_home" />
				<netui:button type="submit" value="${bundle.web['common.button.refresh']}" action="getExportStatus" />
				</p>
			</c:if>
			</br>
			</br>
