...
<script type="text/javascript">
	function getAudioPlayer(parentObj) {
		...
		var fxstring = '<applet CODEBASE = "/ExportWeb/resources/fxResources/" mayscript="true" scriptable="true" archive="audioPlayer.jar,jspeex.jar" code="com.audioPlayer.class" width="200"	height="60" name= "myApplet" id= "myApplet"><PARAM name="byteString" value="'+stringFX+'" ></applet>';
