...
<netui-data:declareBundle bundlePath="dataExportApplicationResource" name="dataexpo"/>

<netui-template:setAttribute name="title" value="${bundle.dataexpo['data.export.window.title']}"/>
