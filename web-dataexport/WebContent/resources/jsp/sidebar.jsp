...
<h1>Export</h1>
<ul>
    <li><a href="/ExportWeb/dataExportPageFlow/begin.do"><span>Export Data</span></a></li>
    <li><a href="/ExportWeb/dataExportPageFlow/beginViewStatus.do"><span>View Status</span></a></li>
