...
function showUnlimitedDateCalendar(formElementChosen, formElementNoEarlier) {

    if( calendar == null )
        calendar = new UnlimitedDateCalendar();
 ...
 function UnlimitedDateCalendar() {
    // member variables
            ...
            for(var day=0; day < 7; day++ ) {
                ...
                if( dayNum > 0 && dayNum <= this.endOfTheMonth(viewedDate.getMonth(), viewedDate.getFullYear()) ) {
                    ...
                    cellDate.setDate( dayNum );
	                  if( (typeof this.isUnlimited != "undefined")  && (this.isUnlimited)  ){

	                   	if( cellDate >= this.noEarlierDate ) 
