...
public class FilterSortPageUtils 
{
    ...
    public static final String TEST_SESSION_DEFAULT_SORT_COLUMN = "TestSessionName";
    public static final String TEST_SESSION_SORT_COLUMN = "StartDate";
   ...
   /*#####################################################################*/ 
    public static SortParams buildTestSessionStudentSortParams(String sortName, String sortOrderBy)
    {
        SortParams sort = new SortParams();
        ...
        String secondarySortName = TEST_SESSION_DEFAULT_SORT_COLUMN;
        if (sortName.equals(TEST_SESSION_DEFAULT_SORT_COLUMN))
             secondarySortName = TEST_SESSION_SORT_COLUMN;
    ...
    public static SortParams buildJobSortParams(String sortName, String sortOrderBy)
    {
        SortParams sort = new SortParams();
	...
	public static FilterParams buildFilterParams(String scoringStatus) {
