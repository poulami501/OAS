...
{ 
    ...
    private final static String REPORT_DATE_FORMAT="MM-dd-yyyy";
    ...
    public static String formatDateToReportDateString(Date date){
        String result = null;
        if (date == null)
            return result;

        SimpleDateFormat sdf = new SimpleDateFormat();
        sdf.applyPattern(REPORT_DATE_FORMAT);
        try{
            result = sdf.format(date);
        }
        catch (Exception e){
