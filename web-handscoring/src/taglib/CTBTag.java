...
public class CTBTag extends TagSupport {
	...
	protected String checkBoxForm(String name, String value, boolean isChecked, boolean isCheckboxDisabled,String onClick) {
        String oldName = "wlw-checkbox_key:" + name + "OldValue";
        String controlName = "wlw-checkbox_key:" + name;
        String hiddenStr = "<input type=\"hidden\" name=\"" + oldName + "\" value=\"on\" >";
        String controlStr = "<input type=\"checkbox\" name=\"" + controlName + "\" " +
                            "value=\""+ value + "\" " +	(isChecked ? " checked=\"true\"" : "") + (isCheckboxDisabled ? " disabled" : "") +
                            " onClick=\"" + onClick + "\" />";
