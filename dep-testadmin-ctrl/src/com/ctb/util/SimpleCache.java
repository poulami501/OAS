...
public class SimpleCache {
	...
	public static void cacheResult(String cacheType, String cacheArg, Object result, String userId) {
		...
		if(userCacheMap == null) {
			...
			OASLogger.getLogger("TestAdmin").debug("SimpleCache.cacheResult: new cache size (users): " + cacheMap.size());
		}
	...
	public static void clearUserCache(String userId) {
		...
		OASLogger.getLogger("TestAdmin").debug("SimpleCache.clearUserCache: new cache size (users): " + cacheMap.size());
	}
