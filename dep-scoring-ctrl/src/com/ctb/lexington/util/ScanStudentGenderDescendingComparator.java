...
/**
 * ScanStudentGenderDescendingComparator
 *
 * Copyright CTB/McGraw-Hill, 2005
 * CONFIDENTIAL
 *
 ...
 */
public class ScanStudentGenderDescendingComparator extends ScanStudentBaseComparator
{
	protected int compareScanStudents(ScanStudentVO s1_, ScanStudentVO s2_){
		int result = compareGenders(s2_, s1_);
		if(result == 0)
