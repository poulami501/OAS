...
/**
 * ScanStudentIdAscendingComparator
 *
 * Copyright CTB/McGraw-Hill, 2005
 * CONFIDENTIAL
 *
 ...
 */
public class ScanStudentIdAscendingComparator extends ScanStudentBaseComparator
{
	protected int compareScanStudents(ScanStudentVO s1_, ScanStudentVO s2_){
		int result = s1_.getStudentNumber().compareTo(s2_.getStudentNumber());
		if(result == 0)
