...
public class GenderOptionList extends com.ctb.lexington.util.OptionList
{
    public static final String OBJECT_LABEL = "genderOptionList";

    public static final String LONG_SALUTATION = "Select a gender...";

    public static final String SHORT_SALUTATION = "Gender...";
    ...
    public GenderOptionList()
    {
        _display_items = new ArrayList();
        _item_values = new ArrayList();

        _display_items.add("MALE");
        _item_values.add("M");

        _display_items.add("FEMALE");
        _item_values.add("F");
     ...
     */
    public String getGenderName(String value_)
    {
     ...
     */
    public ArrayList getUnselectedGenders()
    {
     ...
     */
    public ArrayList getUnselectedGendersWithSalutation(String salutation_)
    {
     ...
     */
    public ArrayList getSelectedGendersByName(String name_)
    {
     ...
     */
    public ArrayList getSelectedGendersByValue(String value_)
    {
