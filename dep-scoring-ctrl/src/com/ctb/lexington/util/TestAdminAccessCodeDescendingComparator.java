 ...
 * @version
 */
public class TestAdminAccessCodeDescendingComparator extends TestAdminBaseComparator
{
	protected int compareTestAdmins(TestAdminVO admin1_, TestAdminVO admin2_){
		int result = standardize(admin2_.getAccessCode()).compareTo(standardize(admin1_.getAccessCode()));
		if(result == 0)
