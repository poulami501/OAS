 ...
 * @version $Id$
 */
public class ContentAreaCumulativeNumberCorrectEvent extends ObjectiveNumberCorrectEvent {
    private final String contentAreaName;
    private final Long subtestId;

    public ContentAreaCumulativeNumberCorrectEvent(final Long testRosterId, final Long subtestId,
