...
public class TrackablePreparedStatement implements PreparedStatement, Trackable {

    PreparedStatement statement ;
    
    public TrackablePreparedStatement(PreparedStatement statement) {
        this.statement = statement;
        DBMonitor.objectOpened(this);
    }

    public void close() throws SQLException{
        DBMonitor.objectClosed(this);
        statement.close();
    }
