 ...
 *
 */
public class IrsTVPrimObjFactData implements Persistent{
	 	private Long factid;
	    ...
	    public boolean equals(Object arg0) {
			return 
				primObjid.equals(((IrsTVPrimObjFactData)arg0).getPrimObjid()) &&
                orgNodeid.equals(((IrsTVPrimObjFactData)arg0).getOrgNodeid()) &&
                studentid.equals(((IrsTVPrimObjFactData)arg0).getStudentid()) &&
                formid.equals(((IrsTVPrimObjFactData)arg0).getFormid()) &&
                sessionid.equals(((IrsTVPrimObjFactData)arg0).getSessionid()) &&
                attr1id.equals(((IrsTVPrimObjFactData)arg0).getAttr1id()) &&
                attr7id.equals(((IrsTVPrimObjFactData)arg0).getAttr7id()) &&
                attr4id.equals(((IrsTVPrimObjFactData)arg0).getAttr4id()) &&
                attr2id.equals(((IrsTVPrimObjFactData)arg0).getAttr2id()) &&
                attr5id.equals(((IrsTVPrimObjFactData)arg0).getAttr5id()) &&
                attr6id.equals(((IrsTVPrimObjFactData)arg0).getAttr6id()) &&
                attr3id.equals(((IrsTVPrimObjFactData)arg0).getAttr3id()) &&
                attr10id.equals(((IrsTVPrimObjFactData)arg0).getAttr10id()) &&
                attr11id.equals(((IrsTVPrimObjFactData)arg0).getAttr11id()) &&
                attr12id.equals(((IrsTVPrimObjFactData)arg0).getAttr12id()) &&
                attr13id.equals(((IrsTVPrimObjFactData)arg0).getAttr13id()) &&
                attr14id.equals(((IrsTVPrimObjFactData)arg0).getAttr14id()) &&
                attr15id.equals(((IrsTVPrimObjFactData)arg0).getAttr15id()) &&
                attr16id.equals(((IrsTVPrimObjFactData)arg0).getAttr16id()) &&
                gradeid.equals(((IrsTVPrimObjFactData)arg0).getGradeid()) &&
                attr9id.equals(((IrsTVPrimObjFactData)arg0).getAttr9id()) &&
                attr8id.equals(((IrsTVPrimObjFactData)arg0).getAttr8id()) &&
                testStartTimestamp.equals(((IrsTVPrimObjFactData)arg0).getTestStartTimestamp()) &&
                testCompletionTimestamp.equals(((IrsTVPrimObjFactData)arg0).getTestCompletionTimestamp()) &&
                assessmentid.equals(((IrsTVPrimObjFactData)arg0).getAssessmentid()) &&
                pointsPossible.equals(((IrsTVPrimObjFactData)arg0).getPointsPossible()) &&
                programid.equals(((IrsTVPrimObjFactData)arg0).getProgramid()) &&
                currentResultid.equals(((IrsTVPrimObjFactData)arg0).getCurrentResultid()) &&
                pointsAttempted.equals(((IrsTVPrimObjFactData)arg0).getPointsAttempted()) &&
                pointsObtained.equals(((IrsTVPrimObjFactData)arg0).getPointsObtained()) &&
                masteryLevelid.equals(((IrsTVPrimObjFactData)arg0).getMasteryLevelid()) &&
                nationalAverage.equals(((IrsTVPrimObjFactData)arg0).getNationalAverage());
        }
