 ...
 *
 */
public class IrsTVCompositeFactData implements Persistent {
    ...
    public boolean equals(Object arg0) {
			return 
				compositeid.equals(((IrsTVCompositeFactData)arg0).getCompositeid()) &&
                orgNodeid.equals(((IrsTVCompositeFactData)arg0).getOrgNodeid()) &&
                studentid.equals(((IrsTVCompositeFactData)arg0).getStudentid()) &&
                formid.equals(((IrsTVCompositeFactData)arg0).getFormid()) &&
                sessionid.equals(((IrsTVCompositeFactData)arg0).getSessionid()) &&
                attr1id.equals(((IrsTVCompositeFactData)arg0).getAttr1id()) &&
                attr7id.equals(((IrsTVCompositeFactData)arg0).getAttr7id()) &&
                attr4id.equals(((IrsTVCompositeFactData)arg0).getAttr4id()) &&
                attr2id.equals(((IrsTVCompositeFactData)arg0).getAttr2id()) &&
                attr5id.equals(((IrsTVCompositeFactData)arg0).getAttr5id()) &&
                attr6id.equals(((IrsTVCompositeFactData)arg0).getAttr6id()) &&
                attr3id.equals(((IrsTVCompositeFactData)arg0).getAttr3id()) &&
                attr10id.equals(((IrsTVCompositeFactData)arg0).getAttr10id()) &&
                attr11id.equals(((IrsTVCompositeFactData)arg0).getAttr11id()) &&
                attr12id.equals(((IrsTVCompositeFactData)arg0).getAttr12id()) &&
                attr13id.equals(((IrsTVCompositeFactData)arg0).getAttr13id()) &&
                attr14id.equals(((IrsTVCompositeFactData)arg0).getAttr14id()) &&
                attr15id.equals(((IrsTVCompositeFactData)arg0).getAttr15id()) &&
                attr16id.equals(((IrsTVCompositeFactData)arg0).getAttr16id()) &&
                gradeid.equals(((IrsTVCompositeFactData)arg0).getGradeid()) &&
                attr9id.equals(((IrsTVCompositeFactData)arg0).getAttr9id()) &&
                attr8id.equals(((IrsTVCompositeFactData)arg0).getAttr8id()) &&
                nrsLevelid.equals(((IrsTVCompositeFactData)arg0).getNrsLevelid()) &&
                scaleScore.equals(((IrsTVCompositeFactData)arg0).getScaleScore()) &&
                gradeEquivalent.equals(((IrsTVCompositeFactData)arg0).getGradeEquivalent()) &&
                normalCurveEquivalent.equals(((IrsTVCompositeFactData)arg0).getNormalCurveEquivalent()) &&
                percentageMastery.equals(((IrsTVCompositeFactData)arg0).getPercentageMastery()) &&
                nationalPercentile.equals(((IrsTVCompositeFactData)arg0).getNationalPercentile()) &&
                nationalStanine.equals(((IrsTVCompositeFactData)arg0).getNationalStanine()) &&
                predictedGed.equals(((IrsTVCompositeFactData)arg0).getPredictedGed()) &&
                testStartTimestamp.equals(((IrsTVCompositeFactData)arg0).getTestStartTimestamp()) &&
                testCompletionTimestamp.equals(((IrsTVCompositeFactData)arg0).getTestCompletionTimestamp()) &&
                assessmentid.equals(((IrsTVCompositeFactData)arg0).getAssessmentid()) &&
                pointsPossible.equals(((IrsTVCompositeFactData)arg0).getPointsPossible()) &&
                programid.equals(((IrsTVCompositeFactData)arg0).getProgramid()) &&
                currentResultid.equals(((IrsTVCompositeFactData)arg0).getCurrentResultid()) &&
                pointsAttempted.equals(((IrsTVCompositeFactData)arg0).getPointsAttempted()) &&
                pointsObtained.equals(((IrsTVCompositeFactData)arg0).getPointsObtained()) &&
                recLevelid.equals(((IrsTVCompositeFactData)arg0).getRecLevelid());
    }
