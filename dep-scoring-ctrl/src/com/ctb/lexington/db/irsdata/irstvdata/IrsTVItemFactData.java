 ...
 *
 */
public class IrsTVItemFactData implements Persistent{
    ...
    public boolean equals(Object arg0) {
			return 
				itemid.equals(((IrsTVItemFactData)arg0).getItemid()) &&
                orgNodeid.equals(((IrsTVItemFactData)arg0).getOrgNodeid()) &&
                studentid.equals(((IrsTVItemFactData)arg0).getStudentid()) &&
                formid.equals(((IrsTVItemFactData)arg0).getFormid()) &&
                sessionid.equals(((IrsTVItemFactData)arg0).getSessionid()) &&
                attr1id.equals(((IrsTVItemFactData)arg0).getAttr1id()) &&
                attr7id.equals(((IrsTVItemFactData)arg0).getAttr7id()) &&
                attr4id.equals(((IrsTVItemFactData)arg0).getAttr4id()) &&
                attr2id.equals(((IrsTVItemFactData)arg0).getAttr2id()) &&
                attr5id.equals(((IrsTVItemFactData)arg0).getAttr5id()) &&
                attr6id.equals(((IrsTVItemFactData)arg0).getAttr6id()) &&
                attr3id.equals(((IrsTVItemFactData)arg0).getAttr3id()) &&
                attr10id.equals(((IrsTVItemFactData)arg0).getAttr10id()) &&
                attr11id.equals(((IrsTVItemFactData)arg0).getAttr11id()) &&
                attr12id.equals(((IrsTVItemFactData)arg0).getAttr12id()) &&
                attr13id.equals(((IrsTVItemFactData)arg0).getAttr13id()) &&
                attr14id.equals(((IrsTVItemFactData)arg0).getAttr14id()) &&
                attr15id.equals(((IrsTVItemFactData)arg0).getAttr15id()) &&
                attr16id.equals(((IrsTVItemFactData)arg0).getAttr16id()) &&
                gradeid.equals(((IrsTVItemFactData)arg0).getGradeid()) &&
                attr9id.equals(((IrsTVItemFactData)arg0).getAttr9id()) &&
                attr8id.equals(((IrsTVItemFactData)arg0).getAttr8id()) &&
                testStartTimestamp.equals(((IrsTVItemFactData)arg0).getTestStartTimestamp()) &&
                testCompletionTimestamp.equals(((IrsTVItemFactData)arg0).getTestCompletionTimestamp()) &&
                assessmentid.equals(((IrsTVItemFactData)arg0).getAssessmentid()) &&
                pointsPossible.equals(((IrsTVItemFactData)arg0).getPointsPossible()) &&
                programid.equals(((IrsTVItemFactData)arg0).getProgramid()) &&
                currentResultid.equals(((IrsTVItemFactData)arg0).getCurrentResultid()) &&
                pointsObtained.equals(((IrsTVItemFactData)arg0).getPointsObtained()) &&
                responseid.equals(((IrsTVItemFactData)arg0).getResponseid()) &&
                nationalAverage.equals(((IrsTVItemFactData)arg0).getNationalAverage());
    }
