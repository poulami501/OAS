 ...
 *
 */
public class IrsTABESecObjFactData implements Persistent{
    ...
    public boolean equals(Object arg0) {
			return 
				secObjid.equals(((IrsTABESecObjFactData)arg0).getSecObjid()) &&
                orgNodeid.equals(((IrsTABESecObjFactData)arg0).getOrgNodeid()) &&
                studentid.equals(((IrsTABESecObjFactData)arg0).getStudentid()) &&
                formid.equals(((IrsTABESecObjFactData)arg0).getFormid()) &&
                sessionid.equals(((IrsTABESecObjFactData)arg0).getSessionid()) &&
                attr1id.equals(((IrsTABESecObjFactData)arg0).getAttr1id()) &&
                attr7id.equals(((IrsTABESecObjFactData)arg0).getAttr7id()) &&
                attr4id.equals(((IrsTABESecObjFactData)arg0).getAttr4id()) &&
                attr2id.equals(((IrsTABESecObjFactData)arg0).getAttr2id()) &&
                attr5id.equals(((IrsTABESecObjFactData)arg0).getAttr5id()) &&
                attr6id.equals(((IrsTABESecObjFactData)arg0).getAttr6id()) &&
                attr3id.equals(((IrsTABESecObjFactData)arg0).getAttr3id()) &&
                attr10id.equals(((IrsTABESecObjFactData)arg0).getAttr10id()) &&
                attr11id.equals(((IrsTABESecObjFactData)arg0).getAttr11id()) &&
                attr12id.equals(((IrsTABESecObjFactData)arg0).getAttr12id()) &&
                attr13id.equals(((IrsTABESecObjFactData)arg0).getAttr13id()) &&
                attr14id.equals(((IrsTABESecObjFactData)arg0).getAttr14id()) &&
                attr15id.equals(((IrsTABESecObjFactData)arg0).getAttr15id()) &&
                attr16id.equals(((IrsTABESecObjFactData)arg0).getAttr16id()) &&
                gradeid.equals(((IrsTABESecObjFactData)arg0).getGradeid()) &&
                attr9id.equals(((IrsTABESecObjFactData)arg0).getAttr9id()) &&
                attr8id.equals(((IrsTABESecObjFactData)arg0).getAttr8id()) &&
                testStartTimestamp.equals(((IrsTABESecObjFactData)arg0).getTestStartTimestamp()) &&
                testCompletionTimestamp.equals(((IrsTABESecObjFactData)arg0).getTestCompletionTimestamp()) &&
                assessmentid.equals(((IrsTABESecObjFactData)arg0).getAssessmentid()) &&
                pointsPossible.equals(((IrsTABESecObjFactData)arg0).getPointsPossible()) &&
                programid.equals(((IrsTABESecObjFactData)arg0).getProgramid()) &&
                currentResultid.equals(((IrsTABESecObjFactData)arg0).getCurrentResultid()) &&
                pointsAttempted.equals(((IrsTABESecObjFactData)arg0).getPointsAttempted()) &&
                pointsObtained.equals(((IrsTABESecObjFactData)arg0).getPointsObtained()) &&
                masteryLevelid.equals(((IrsTABESecObjFactData)arg0).getMasteryLevelid());
    }
