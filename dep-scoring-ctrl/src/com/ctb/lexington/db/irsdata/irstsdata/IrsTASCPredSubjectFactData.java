 ...
 *
 */
public class IrsTASCPredSubjectFactData implements Persistent {
    ...
    public boolean equals(Object arg0) {
			return 
				predSubjectid.equals(((IrsTASCPredSubjectFactData)arg0).getPredSubjectid()) &&
                orgNodeid.equals(((IrsTASCPredSubjectFactData)arg0).getOrgNodeid()) &&
                studentid.equals(((IrsTASCPredSubjectFactData)arg0).getStudentid()) &&
                formid.equals(((IrsTASCPredSubjectFactData)arg0).getFormid()) &&
                sessionid.equals(((IrsTASCPredSubjectFactData)arg0).getSessionid()) &&
                attr1id.equals(((IrsTASCPredSubjectFactData)arg0).getAttr1id()) &&
                attr7id.equals(((IrsTASCPredSubjectFactData)arg0).getAttr7id()) &&
                attr4id.equals(((IrsTASCPredSubjectFactData)arg0).getAttr4id()) &&
                attr2id.equals(((IrsTASCPredSubjectFactData)arg0).getAttr2id()) &&
                attr5id.equals(((IrsTASCPredSubjectFactData)arg0).getAttr5id()) &&
                attr6id.equals(((IrsTASCPredSubjectFactData)arg0).getAttr6id()) &&
                attr3id.equals(((IrsTASCPredSubjectFactData)arg0).getAttr3id()) &&
                attr10id.equals(((IrsTASCPredSubjectFactData)arg0).getAttr10id()) &&
                attr11id.equals(((IrsTASCPredSubjectFactData)arg0).getAttr11id()) &&
                attr12id.equals(((IrsTASCPredSubjectFactData)arg0).getAttr12id()) &&
                attr13id.equals(((IrsTASCPredSubjectFactData)arg0).getAttr13id()) &&
                attr14id.equals(((IrsTASCPredSubjectFactData)arg0).getAttr14id()) &&
                attr15id.equals(((IrsTASCPredSubjectFactData)arg0).getAttr15id()) &&
                attr16id.equals(((IrsTASCPredSubjectFactData)arg0).getAttr16id()) &&
                gradeid.equals(((IrsTASCPredSubjectFactData)arg0).getGradeid()) &&
                attr9id.equals(((IrsTASCPredSubjectFactData)arg0).getAttr9id()) &&
                attr8id.equals(((IrsTASCPredSubjectFactData)arg0).getAttr8id()) &&
                recActivityid.equals(((IrsTASCPredSubjectFactData)arg0).getRecActivityid()) &&
                predictedGed.equals(((IrsTASCPredSubjectFactData)arg0).getPredictedGed()) &&
                testStartTimestamp.equals(((IrsTASCPredSubjectFactData)arg0).getTestStartTimestamp()) &&
                testCompletionTimestamp.equals(((IrsTASCPredSubjectFactData)arg0).getTestCompletionTimestamp()) &&
                assessmentid.equals(((IrsTASCPredSubjectFactData)arg0).getAssessmentid()) &&
                programid.equals(((IrsTASCPredSubjectFactData)arg0).getProgramid()) &&
                currentResultid.equals(((IrsTASCPredSubjectFactData)arg0).getCurrentResultid());
    }
