package com.ctb.lexington.db.irsdata.irstcdata;
 ...
 *
 */
public class IrsTCContentAreaFactData implements Persistent{
    ...
    public boolean equals(Object arg0) {
			return 
				contentAreaid.equals(((IrsTCContentAreaFactData)arg0).getContentAreaid()) &&
                orgNodeid.equals(((IrsTCContentAreaFactData)arg0).getOrgNodeid()) &&
                studentid.equals(((IrsTCContentAreaFactData)arg0).getStudentid()) &&
                formid.equals(((IrsTCContentAreaFactData)arg0).getFormid()) &&
                sessionid.equals(((IrsTCContentAreaFactData)arg0).getSessionid()) &&
                attr1id.equals(((IrsTCContentAreaFactData)arg0).getAttr1id()) &&
                attr7id.equals(((IrsTCContentAreaFactData)arg0).getAttr7id()) &&
                attr4id.equals(((IrsTCContentAreaFactData)arg0).getAttr4id()) &&
                attr2id.equals(((IrsTCContentAreaFactData)arg0).getAttr2id()) &&
                attr5id.equals(((IrsTCContentAreaFactData)arg0).getAttr5id()) &&
                attr6id.equals(((IrsTCContentAreaFactData)arg0).getAttr6id()) &&
                attr3id.equals(((IrsTCContentAreaFactData)arg0).getAttr3id()) &&
                attr10id.equals(((IrsTCContentAreaFactData)arg0).getAttr10id()) &&
                attr11id.equals(((IrsTCContentAreaFactData)arg0).getAttr11id()) &&
                attr12id.equals(((IrsTCContentAreaFactData)arg0).getAttr12id()) &&
                attr13id.equals(((IrsTCContentAreaFactData)arg0).getAttr13id()) &&
                attr14id.equals(((IrsTCContentAreaFactData)arg0).getAttr14id()) &&
                attr15id.equals(((IrsTCContentAreaFactData)arg0).getAttr15id()) &&
                attr16id.equals(((IrsTCContentAreaFactData)arg0).getAttr16id()) &&
                gradeid.equals(((IrsTCContentAreaFactData)arg0).getGradeid()) &&
                attr9id.equals(((IrsTCContentAreaFactData)arg0).getAttr9id()) &&
                attr8id.equals(((IrsTCContentAreaFactData)arg0).getAttr8id()) &&
                nrsLevelid.equals(((IrsTCContentAreaFactData)arg0).getNrsLevelid()) &&
                scaleScore.equals(((IrsTCContentAreaFactData)arg0).getScaleScore()) &&
                gradeEquivalent.equals(((IrsTCContentAreaFactData)arg0).getGradeEquivalent()) &&
                normalCurveEquivalent.equals(((IrsTCContentAreaFactData)arg0).getNormalCurveEquivalent()) &&
                percentageMastery.equals(((IrsTCContentAreaFactData)arg0).getPercentageMastery()) &&
                nationalPercentile.equals(((IrsTCContentAreaFactData)arg0).getNationalPercentile()) &&
                nationalStanine.equals(((IrsTCContentAreaFactData)arg0).getNationalStanine()) &&
                predictedGed.equals(((IrsTCContentAreaFactData)arg0).getPredictedGed()) &&
                testStartTimestamp.equals(((IrsTCContentAreaFactData)arg0).getTestStartTimestamp()) &&
                testCompletionTimestamp.equals(((IrsTCContentAreaFactData)arg0).getTestCompletionTimestamp()) &&
                assessmentid.equals(((IrsTCContentAreaFactData)arg0).getAssessmentid()) &&
                pointsPossible.equals(((IrsTCContentAreaFactData)arg0).getPointsPossible()) &&
                programid.equals(((IrsTCContentAreaFactData)arg0).getProgramid()) &&
                currentResultid.equals(((IrsTCContentAreaFactData)arg0).getCurrentResultid()) &&
                pointsAttempted.equals(((IrsTCContentAreaFactData)arg0).getPointsAttempted()) &&
                pointsObtained.equals(((IrsTCContentAreaFactData)arg0).getPointsObtained()) &&
                recLevelid.equals(((IrsTCContentAreaFactData)arg0).getRecLevelid()) &&
                gradeBand.equals(((IrsTCContentAreaFactData)arg0).getGradeBand());
    }
