 ...
 *
 */
public class IrsTCItemFactData implements Persistent{
    ...
    public boolean equals(Object arg0) {
			return 
				itemid.equals(((IrsTCItemFactData)arg0).getItemid()) &&
                orgNodeid.equals(((IrsTCItemFactData)arg0).getOrgNodeid()) &&
                studentid.equals(((IrsTCItemFactData)arg0).getStudentid()) &&
                formid.equals(((IrsTCItemFactData)arg0).getFormid()) &&
                sessionid.equals(((IrsTCItemFactData)arg0).getSessionid()) &&
                attr1id.equals(((IrsTCItemFactData)arg0).getAttr1id()) &&
                attr7id.equals(((IrsTCItemFactData)arg0).getAttr7id()) &&
                attr4id.equals(((IrsTCItemFactData)arg0).getAttr4id()) &&
                attr2id.equals(((IrsTCItemFactData)arg0).getAttr2id()) &&
                attr5id.equals(((IrsTCItemFactData)arg0).getAttr5id()) &&
                attr6id.equals(((IrsTCItemFactData)arg0).getAttr6id()) &&
                attr3id.equals(((IrsTCItemFactData)arg0).getAttr3id()) &&
                attr10id.equals(((IrsTCItemFactData)arg0).getAttr10id()) &&
                attr11id.equals(((IrsTCItemFactData)arg0).getAttr11id()) &&
                attr12id.equals(((IrsTCItemFactData)arg0).getAttr12id()) &&
                attr13id.equals(((IrsTCItemFactData)arg0).getAttr13id()) &&
                attr14id.equals(((IrsTCItemFactData)arg0).getAttr14id()) &&
                attr15id.equals(((IrsTCItemFactData)arg0).getAttr15id()) &&
                attr16id.equals(((IrsTCItemFactData)arg0).getAttr16id()) &&
                gradeid.equals(((IrsTCItemFactData)arg0).getGradeid()) &&
                attr9id.equals(((IrsTCItemFactData)arg0).getAttr9id()) &&
                attr8id.equals(((IrsTCItemFactData)arg0).getAttr8id()) &&
                testStartTimestamp.equals(((IrsTCItemFactData)arg0).getTestStartTimestamp()) &&
                testCompletionTimestamp.equals(((IrsTCItemFactData)arg0).getTestCompletionTimestamp()) &&
                assessmentid.equals(((IrsTCItemFactData)arg0).getAssessmentid()) &&
                pointsPossible.equals(((IrsTCItemFactData)arg0).getPointsPossible()) &&
                programid.equals(((IrsTCItemFactData)arg0).getProgramid()) &&
                currentResultid.equals(((IrsTCItemFactData)arg0).getCurrentResultid()) &&
                pointsObtained.equals(((IrsTCItemFactData)arg0).getPointsObtained()) &&
                responseid.equals(((IrsTCItemFactData)arg0).getResponseid());
    }
