 ...
 *
 */
public class IrsTCSecObjFactData implements Persistent{
    ...
    public boolean equals(Object arg0) {
			return 
				secObjid.equals(((IrsTCSecObjFactData)arg0).getSecObjid()) &&
                orgNodeid.equals(((IrsTCSecObjFactData)arg0).getOrgNodeid()) &&
                studentid.equals(((IrsTCSecObjFactData)arg0).getStudentid()) &&
                formid.equals(((IrsTCSecObjFactData)arg0).getFormid()) &&
                sessionid.equals(((IrsTCSecObjFactData)arg0).getSessionid()) &&
                attr1id.equals(((IrsTCSecObjFactData)arg0).getAttr1id()) &&
                attr7id.equals(((IrsTCSecObjFactData)arg0).getAttr7id()) &&
                attr4id.equals(((IrsTCSecObjFactData)arg0).getAttr4id()) &&
                attr2id.equals(((IrsTCSecObjFactData)arg0).getAttr2id()) &&
                attr5id.equals(((IrsTCSecObjFactData)arg0).getAttr5id()) &&
                attr6id.equals(((IrsTCSecObjFactData)arg0).getAttr6id()) &&
                attr3id.equals(((IrsTCSecObjFactData)arg0).getAttr3id()) &&
                attr10id.equals(((IrsTCSecObjFactData)arg0).getAttr10id()) &&
                attr11id.equals(((IrsTCSecObjFactData)arg0).getAttr11id()) &&
                attr12id.equals(((IrsTCSecObjFactData)arg0).getAttr12id()) &&
                attr13id.equals(((IrsTCSecObjFactData)arg0).getAttr13id()) &&
                attr14id.equals(((IrsTCSecObjFactData)arg0).getAttr14id()) &&
                attr15id.equals(((IrsTCSecObjFactData)arg0).getAttr15id()) &&
                attr16id.equals(((IrsTCSecObjFactData)arg0).getAttr16id()) &&
                gradeid.equals(((IrsTCSecObjFactData)arg0).getGradeid()) &&
                attr9id.equals(((IrsTCSecObjFactData)arg0).getAttr9id()) &&
                attr8id.equals(((IrsTCSecObjFactData)arg0).getAttr8id()) &&
                testStartTimestamp.equals(((IrsTCSecObjFactData)arg0).getTestStartTimestamp()) &&
                testCompletionTimestamp.equals(((IrsTCSecObjFactData)arg0).getTestCompletionTimestamp()) &&
                assessmentid.equals(((IrsTCSecObjFactData)arg0).getAssessmentid()) &&
                pointsPossible.equals(((IrsTCSecObjFactData)arg0).getPointsPossible()) &&
                programid.equals(((IrsTCSecObjFactData)arg0).getProgramid()) &&
                currentResultid.equals(((IrsTCSecObjFactData)arg0).getCurrentResultid()) &&
                pointsAttempted.equals(((IrsTCSecObjFactData)arg0).getPointsAttempted()) &&
                pointsObtained.equals(((IrsTCSecObjFactData)arg0).getPointsObtained()) &&
                masteryLevelid.equals(((IrsTCSecObjFactData)arg0).getMasteryLevelid());
    }
