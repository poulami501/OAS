 ...
 *
 */
public class IrsTCPrimObjFactData implements Persistent{
	 	private Long factid;
	    ...
	    public boolean equals(Object arg0) {
			return 
				primObjid.equals(((IrsTCPrimObjFactData)arg0).getPrimObjid()) &&
                orgNodeid.equals(((IrsTCPrimObjFactData)arg0).getOrgNodeid()) &&
                studentid.equals(((IrsTCPrimObjFactData)arg0).getStudentid()) &&
                formid.equals(((IrsTCPrimObjFactData)arg0).getFormid()) &&
                sessionid.equals(((IrsTCPrimObjFactData)arg0).getSessionid()) &&
                attr1id.equals(((IrsTCPrimObjFactData)arg0).getAttr1id()) &&
                attr7id.equals(((IrsTCPrimObjFactData)arg0).getAttr7id()) &&
                attr4id.equals(((IrsTCPrimObjFactData)arg0).getAttr4id()) &&
                attr2id.equals(((IrsTCPrimObjFactData)arg0).getAttr2id()) &&
                attr5id.equals(((IrsTCPrimObjFactData)arg0).getAttr5id()) &&
                attr6id.equals(((IrsTCPrimObjFactData)arg0).getAttr6id()) &&
                attr3id.equals(((IrsTCPrimObjFactData)arg0).getAttr3id()) &&
                attr10id.equals(((IrsTCPrimObjFactData)arg0).getAttr10id()) &&
                attr11id.equals(((IrsTCPrimObjFactData)arg0).getAttr11id()) &&
                attr12id.equals(((IrsTCPrimObjFactData)arg0).getAttr12id()) &&
                attr13id.equals(((IrsTCPrimObjFactData)arg0).getAttr13id()) &&
                attr14id.equals(((IrsTCPrimObjFactData)arg0).getAttr14id()) &&
                attr15id.equals(((IrsTCPrimObjFactData)arg0).getAttr15id()) &&
                attr16id.equals(((IrsTCPrimObjFactData)arg0).getAttr16id()) &&
                gradeid.equals(((IrsTCPrimObjFactData)arg0).getGradeid()) &&
                attr9id.equals(((IrsTCPrimObjFactData)arg0).getAttr9id()) &&
                attr8id.equals(((IrsTCPrimObjFactData)arg0).getAttr8id()) &&
                testStartTimestamp.equals(((IrsTCPrimObjFactData)arg0).getTestStartTimestamp()) &&
                testCompletionTimestamp.equals(((IrsTCPrimObjFactData)arg0).getTestCompletionTimestamp()) &&
                assessmentid.equals(((IrsTCPrimObjFactData)arg0).getAssessmentid()) &&
                pointsPossible.equals(((IrsTCPrimObjFactData)arg0).getPointsPossible()) &&
                programid.equals(((IrsTCPrimObjFactData)arg0).getProgramid()) &&
                currentResultid.equals(((IrsTCPrimObjFactData)arg0).getCurrentResultid()) &&
                pointsAttempted.equals(((IrsTCPrimObjFactData)arg0).getPointsAttempted()) &&
                pointsObtained.equals(((IrsTCPrimObjFactData)arg0).getPointsObtained()) &&
                masteryLevelid.equals(((IrsTCPrimObjFactData)arg0).getMasteryLevelid());
        }
