<div id="changeUserPassword"
	...
	<div id="displayMessageChangePassword" class="roundedMessage" style="display:none; width:760px;background-color: #FFFFFF; font-family: Arial, Verdana, Sans Serif; font-size: 12px; font-style: normal; font-weight: normal; border: 1px solid #A6C9E2;">
			<table>
				<tr>
