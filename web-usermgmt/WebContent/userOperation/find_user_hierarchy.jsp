...
<input type="hidden" id="hasSSOBlockUserModifications" name = "hasSSOBlockUserModifications" value='<%=session.getAttribute("hasSSOBlockUserModifications") %>'/>
...
<div id="nodataSelectedPopUp"
	...
	<div style="padding-top:10px;text-align:center;">
		<div style="text-align: left;">
			<lb:label key="user.no.data.selected"/>
		</div>
	</div>
</div>