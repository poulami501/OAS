    ...
    <tr class="sortable">
	 ...
	 <table class="transparent">
	    ...
	    <tr class="transparent">
	    	...
	    	<div id = "orgNodeHierarchy" style=" overflow:auto; height: 485px;  width: 200px; font-family: Arial, Verdana, Sans Serif; font-size: 13px; font-style: normal; font-weight: normal;">
