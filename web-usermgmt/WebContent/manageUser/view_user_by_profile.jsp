...
<table class="transparent">
    <tr class="transparent">
        ...
        <td class="transparent"><netui-compat:label value="{actionForm.userProfile.firstName}"/></td>
    </tr>
    <tr class="transparent">
        <td class="transparent" width="100"><netui:content value="Middle Name:"/></td>
        <td class="transparent"><netui-compat:label value="{actionForm.userProfile.middleName}"/></td>
    </tr>
    <tr class="transparent">
        <td class="transparent" width="100"><netui:content value="Last Name:"/></td>
        <td class="transparent"><netui-compat:label value="{actionForm.userProfile.lastName}"/></td>
    </tr>
    <tr class="transparent">
...
<table class="transparent">
    <tr class="transparent">
        ...
        <td class="transparent"><netui-compat:label value="{actionForm.userProfile.email}"/></td>
    </tr>
    <tr class="transparent">
        <td class="transparent" width="100"><netui:content value="Time Zone:"/></td>
        <td class="transparent"><netui-compat:label value="{actionForm.userProfile.timeZoneDesc}"/></td>
    </tr>
    <tr class="transparent">
        <td class="transparent" width="100"><netui:content value="Role:"/></td>
        <td class="transparent"><netui-compat:label value="{actionForm.userProfile.roleInitCap}"/></td>
    </tr>
     <%--CR Dex --%>
    <tr class="transparent">
