...
<table class="tableFilter">
    ...
    <tr class="tableFilter">
        ...
        <td class="tableFilter" width="*">
            <netui:button styleClass="button" value="Search" type="button" onClick="setElementValueAndSubmitWithAnchor('currentAction', 'applySearch', 'userProfileResult');" tabindex="6"/>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <netui:button styleClass="button" value="Clear All" type="button" onClick="setElementValueAndSubmit('currentAction', 'clearSearch');" tabindex="7"/>&nbsp;
        </td>
    </tr>
</table>    
<br/>
