 ...
 * UserSuggestions
 */
function UserSuggestions(id, url) 
{
    this.controlId = id;
    this.actionUrl = url;
    sTextboxValue = "";
 ...
 */
UserSuggestions.prototype.requestSuggestions = function (oAutoSuggestControl, bTypeAhead) 
{
 ...
 * findSuggestions 
 */
UserSuggestions.prototype.findSuggestions = function(controlId, actionUrl) 
{
 ...
 * executeXhr 
 */
UserSuggestions.prototype.executeXhr = function(callback, url, controlId, controlValue) 
{
 ...
 */
UserSuggestions.prototype.processFindSuggestions = function()
{
 ...
 */
UserSuggestions.prototype.getXmlHttpRequestObject = function()
{	
...
{
    var url = "/UserWeb/manageUser/findSuggestions.do";    
    var element = document.getElementById(controlId);
    element.setAttribute("autocomplete", "off");

    return new AutoSuggestControl(element, new UserSuggestions(controlId, url));
}
