...
<lb:bundle baseName="userApplicationResource" />
	...
	<div id="page-wrap">
        <ul class="dropdown">
        	<li id="assessments" class="simpleMenu"><a href="#"><lb:label key="user.menu.assessments" /></a>
        		<ul class="sub_menu">
        			 <li>   			 	
        	...
        	<li id="organizations" class="simpleMenu"><a href="#"><lb:label key="user.menu.orgs" /></a>        	
        		<ul class="sub_menu">
        			 <li>   			
        	...
        	<li id="reports" class="simpleMenu"><a href="#"  id="reportsLink" onClick="gotoMenuAction('reports.do', 'reportsLink');"><lb:label key="user.menu.reports" /></a>
        	</li>
        	</c:if>		
        	<li id="services" class="simpleMenu"><a href="#"><lb:label key="user.menu.services" /></a>
        		<ul class="sub_menu">
        			 <li>
        			 ...
        			 <c:if test="${sessionScope.hasUploadDownloadConfigured}">	
	        			 <li>
	        				...
	        				<ul>
	        					<li><a href="#" id="downloadDataLink" onClick="gotoMenuAction('services.do', 'downloadDataLink');"><lb:label key="user.menu.import" /></a></li>
	        					<li><a href="#" id="uploadDataLink" onClick="gotoMenuAction('services.do', 'uploadDataLink');"><lb:label key="user.menu.export" /></a></li>
	        				</ul>
	        			 </li>
        			 </c:if>	
