...
{     
	...
	private String isStudentsSession = "F";
    ...
    public TestSessionVO(TestSession ts) 
    {
        ...
        if(ts.getTestAdminStatus().equals("PA")) {
        	this.testAdminStatus = "Completed";
        }
        else if(ts.getTestAdminStatus().equals("CU")) {
        	this.testAdminStatus = "Current";
        } else if (ts.getTestAdminStatus().equals("FU")){
        	this.testAdminStatus = "Future";
        }
        ...
        //Change for License Management
         ...
         if(ts.getProductType()!=null){
        	 ...
        	 this.isTabeProduct = TestSessionUtils.isTabeProduct(productType);
        	 this.isTabeAdaptiveProduct = TestSessionUtils.isTabeAdaptiveProduct(productType);
         }
         this.itemSetId = ts.getItemSetId();
         
         if(ts.getIsStudentsSession()!=null){
        	 this.isStudentsSession  = ts.getIsStudentsSession();
         }
    }     
