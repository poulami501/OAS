...
{ 
    ...
    private String orgNodeNamesList;
    private String orgNodeIdList;
	...
	/**
	 * @return the orgNodeNamesList
	 */
	public String getOrgNodeNamesList() {
		return orgNodeNamesList;
	}


	/**
	 * @param orgNodeNamesList the orgNodeNamesList to set
	 */
	public void setOrgNodeNamesList(String orgNodeNamesList) {
		this.orgNodeNamesList = orgNodeNamesList;
	}


	/**
	 * @return the orgNodeIdList
	 */
	public String getOrgNodeIdList() {
		return orgNodeIdList;
	}


	/**
	 * @param orgNodeIdList the orgNodeIdList to set
	 */
	public void setOrgNodeIdList(String orgNodeIdList) {
		this.orgNodeIdList = orgNodeIdList;
	}
} 
