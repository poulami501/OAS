...
public class FormatUtils
{
     ...
     */
    public static String[] generateBasicStudentUsernames( Student student_ )
    {
        ...
        Date birthdate = (student_.getBirthdate() != null) ? new Date(student_.getBirthdate().getTime()) : new Date();
...
/*
 * $Log$
 * Revision 1.2  2007/05/08 20:19:22  ncohen
 * merge OAS50 into trunk
 *
 * Revision 1.1.2.1  2007/04/24 23:47:46  ttruong
 * Rapid Registration UI
 *
 * Revision 1.1  2007/01/22 22:51:37  ttruong
 * Initial created
 *
