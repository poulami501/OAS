...
$().ready(function(){
	...
	$(window).resize(function() {
		if($(window).height()!=lastWindowHeight || $(window).width()!=lastWindowWidth){
	        ...
	        if( $("#studentRegistrationGrid").length > 0){
	         	$("#studentRegistrationGrid").setGridWidth($("#jqGrid-content-section").width());
	         }
	         if($("#sessionRegistrationGrid").length >0){
	         	$("#sessionRegistrationGrid").setGridWidth($("#jqGrid-content-section").width());
	         }
