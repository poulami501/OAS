...
<netui-data:declareBundle bundlePath="studentRegistrationResource" name="register"/>

<netui-template:setAttribute name="title" value="${bundle.register['student.registration.window.title']}"/>
...
<![endif]-->
  <head>
    ...
    <link href="<%=request.getContextPath()%>/resources/css/popup_menu.css" rel="stylesheet" type="text/css" />
     <link href="<%=request.getContextPath()%>/resources/css/editSubtest.css" rel="stylesheet" type="text/css" />
