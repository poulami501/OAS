		...
		<table class="transparent">
			...
			<tr class="transparent">
				...
				<table class="transparent">
					...
					<tr class="transparent">
						<td class="transparent-small"><input disabled="true" type="checkbox" name="specialPrograms"
							id="specialPrograms3" value="State Corrections" checked="false">State Corrections</input></td>
					</tr>
					<tr class="transparent">
						<td class="transparent-small"><input disabled="true" type="checkbox" name="specialPrograms"
							id="specialPrograms4" value="Homeless Program" checked="false">Homeless Program</input></td>
					</tr>
					<tr class="transparent">
						<td class="transparent-small"><input disabled="true" type="checkbox" name="specialPrograms"
							id="specialPrograms5" value="Workplace Ed." checked="false">Workplace Ed.</input></td>
					</tr>
					<tr class="transparent">
						<td class="transparent-small"><input disabled="true" type="checkbox" name="specialPrograms"
							id="specialPrograms6" value="Tutoring" checked="false">Tutoring</input></td>
					</tr>
					<tr class="transparent">
						<td class="transparent-small"><input disabled="true" type="checkbox" name="specialPrograms"
							id="specialPrograms7" value="Distance Learning" checked="false">Distance Learning</input></td>
					</tr>
					<tr class="transparent">
						<td class="transparent-small"><input disabled="true" type="checkbox" name="specialPrograms"
							id="specialPrograms8" value="Special Needs" checked="false">Special Needs</input></td>
					</tr>
					<tr class="transparent">
						<td class="transparent-small"><input disabled="true" type="checkbox" name="specialPrograms"
							id="specialPrograms9" value="Alternative Ed. (K12)" checked="false">Alternative Ed. (K12)</input></td>
					</tr>
					<tr class="transparent">
						<td class="transparent-small"><input disabled="true" type="checkbox" name="specialPrograms"
							id="specialPrograms10" value="Non-traditional Training" checked="false">Non-traditional Training</input></td>
					</tr>
					<tr class="transparent">
						<td class="transparent-small"><input disabled="true" type="checkbox" name="specialPrograms"
							id="specialPrograms11" value="El Civics" checked="false">El Civics</input></td>
					</tr>
					<tr class="transparent">
						<td class="transparent-small"><input disabled="true" type="checkbox" name="specialPrograms"
							id="specialPrograms12" value="Carl Perkins" checked="false">Carl Perkins</input></td>
					</tr>
					<tr class="transparent">
						<td class="transparent-small"><input disabled="true" type="checkbox" name="specialPrograms"
							id="specialPrograms13" value="Other" checked="false">Other</input></td>
					</tr>
				</table>
				</td>
			</tr>
