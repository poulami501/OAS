 	...
 	$("#immdRptGrid").jqGrid({         
	 	...
	 	datatype: "json",         
	   	...
	   	colModel:[
	   		...
	   		{name:'grade',			index:'grade',				width:60,  editable: true, align:"left",				search: true, sortable:true, cellattr: function (rowId, tv, rawObject, cm, rdata) { return 'style="white-space: normal;' }, stype: 'select', searchoptions:{ sopt:['eq'], value: gradeOptions } },
	   		...
	   		{name:'testCatalogName',index:'testCatalogName',	width:180, editable: true, align:"left", 				search: true, sortable:true, cellattr: function (rowId, tv, rawObject, cm, rdata) { return 'style="white-space: normal;' }, stype: 'select', searchoptions:{ sopt:['eq'], value: testNameOptions } },
	   		{name:'contentAreaString',index:'contentAreaString',width:120, editable: true, align:"left",sorttype:'text',search: true, sortable:true, cellattr: function (rowId, tv, rawObject, cm, rdata) { return 'style="white-space: normal;' }, stype: 'select', searchoptions:{ sopt:['cn'], value: contentAreaOptions } },
	   	    {name:'testAdminId',	index:'testAdminId', 		width:10,  editable: true, align:"left",hidden: true,	search: false,sortable:true, cellattr: function (rowId, tv, rawObject, cm, rdata) { return 'style="white-space: normal;' } }
	   	],
		...
		loadComplete: function () {
			if ($('#immdRptGrid').getGridParam('records') === 0) {
           	...
           	//("#immdRptGrid").setGridParam({datatype:'local'});
