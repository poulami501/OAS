 	...
 	$("#immdRptGrid").jqGrid({         
	 	...
	 	datatype: "json",         
	   	...
	   	colModel:[
	   		...
	   		{name:'defaultScheduler',	index:'defaultScheduler', width:70, editable: true, align:"left",sorttype:'text',search: false,sortable:true, cellattr: function (rowId, tv, rawObject, cm, rdata) { return 'style="white-space: normal;' } },
