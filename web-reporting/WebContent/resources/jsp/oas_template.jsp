...
<netui-data:declareBundle bundlePath="immediateReportingResources" name="imdreport"/>

<netui-template:setAttribute name="title" value="${bundle.imdreport['immediateReport.window.title']}"/>
