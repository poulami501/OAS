		...
		<td>
    		<table class="transparent">
				<tr class="transparent">
					<td>
					<% if(productId == 7000){ %>
			    		<h1><lb:label key="immediate.report.page.titleOrg.LLEAB" /></h1>
			    	<%} else if(productId == 7500){%>
			    		<h1><lb:label key="immediate.report.page.titleOrg.LL2ND" /></h1>
			    	<%} %>	
					</td>
				</tr>
				<tr> 
					<td class="subtitle">  
						<lb:label key="immediate.report.page.subtitleOrg" />
					</td>	
				</tr>
			</table>		
		</td>
		        ...
		        <td style="vertical-align:top; width:16%;" align="left">
		 		...
		 		<td style="vertical-align:top;" id="jqGrid-content-section">
		 			 <div id="studentView" style="float: right;">
		      			<table id="orgImmdRptGrid" class="gridTable"></table>
						<div id="orgImmdRptGridPager" class="gridTable"></div>
					</div>
		 		</td>
	    	</tr>
		</table>
