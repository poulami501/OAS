...
{ 
    public static List<BroadcastMessage> getBroadcastMessages(com.ctb.control.db.BroadcastMessageLog message, String userName) {
    ...
    public static String buildBroadcastMessages(List<BroadcastMessage> broadcastMessages)
    {        
        ...
        if (broadcastMessages.size() > 0)
        {
            ...
            for (int i=0; i<broadcastMessages.size(); i++) {
            	BroadcastMessage bm = broadcastMessages.get(i);
