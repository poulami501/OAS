...
public class GroupImmediatePDFReportUtils extends StudentImmediateReportUtils implements ImmediateReport  {
	...
	public void generateReport(Integer pageCount) throws Exception {
	...
	public void openDocument(OutputStream out) throws DocumentException {
		...
		this.writer = PDFUtils.getWriter(document, out);
		initialize();
	}
