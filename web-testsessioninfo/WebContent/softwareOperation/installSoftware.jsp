		...
		<netui:form action="services_installSoftware">
			...
			<table width="97%" style="margin: 15px auto;" border="0">
				...
				<tr>
					...
					<table>
						<tr>
							...
							<div id="errorIcon" style="display: none;"><img
								src="<%=request.getContextPath()%>/resources/images/messaging/icon_error.gif" border="0" width="16" height="16">
							</div>
							<div id="infoIcon" style="display: none;"><img
				...
				<tr>
					...
					<p align="right">
					<% if (isLasLinkCustomer.booleanValue()) { %> <a href="#"
						onClick="newWindow('/help/pdfs/min_sys_req_client_pc_LAS.pdf');return false;"><netui:content
						value="${bundle.web['installClient.viewSystemRequirements']}" /></a> <% } else { %> <a href="#"
						onClick="newWindow('/help/pdfs/min_sys_req_client_pc.pdf');return false;"><netui:content
						value="${bundle.web['installClient.viewSystemRequirements']}" /></a> <% } %>
					</p>
					</td>
				</tr>
				...
				<tr class="transparent">
					...
					<table class="transparent">
						...
						<tr class="transparent">
							<td class="transparent-top"><netui:content
								value="<b>For Mac</b>: Go to the Adobe website and download the latest Adobe Flash for free." /> <br>
							<a href="#" onclick="newWindow('http://www.adobe.com/products/flashplayer/');"><netui:content
								value="http://www.adobe.com/products/flashplayer/" /></a> <br>
							</td>
						</tr>
					</table>
					</td>
    ...
    %>
			...
			<%} %>	
				<tr class="transparent">
                   ...
                   {
                 %>
							<td class="transparent-top" width="5%"><img class="transparent-top"
								src="../resources/images/legacy/icon_pc.gif" width="52" height="33" /></td>
							<td class="transparent-top" width="40%"><b><netui:content
								value="${bundle.web['installClient.windows.clientName']}" /></b><br>
							<i><netui:content value="${bundle.web['installClient.windows.OS']}" /></i><br>
							<a href="#" onclick="<%= href_PC %>" class="rounded {transparent} button" tabindex="1"> <netui:content
                     ...
                     %>   
                          ...
                          <%} %>
							...
							<td class="transparent-top" width="5%"><img class="transparent-top"
								src="../resources/images/legacy/icon_pc.gif" width="52" height="33" /></td>
							<td class="transparent-top" width="40%"><b><netui:content
								value="${bundle.web['installClient.windows.clientName2']}" /></b><br>
							<i><netui:content value="${bundle.web['installClient.windows.OS']}" /></i><br>

							<a href="#" onclick="<%= href_RUNPC %>" class="rounded {transparent} button" tabindex="1"> <netui:content
                 ...
                 {
            	%>
							<td class="transparent-top" width="5%"><img class="transparent"
         ...
         if (!isLasLinkCustomer.booleanValue()) {
            ...
            %>
						...
						<%if(!isStdLinuxInstallMissing )
			             ...
			             %>
							<td class="transparent-top" width="5%"><img class="transparent"
								src="../resources/images/legacy/icon_linux.png" /></td>
							<td class="transparent-top" width="40%"><b><netui:content
								value="${bundle.web['installClient.linux.clientName']}" /></b><br>
							<i><netui:content value="${bundle.web['installClient.linux.OS']}" /></i><br>
							<div id="allowDownload" style="display: none"><a href="#" onclick="<%= href_LINUX %>"
								class="rounded {transparent} button" tabindex="3"> <netui:content
								value="${bundle.web['installClient.windows.buttonText']}" /> </a></div>
							<div id="notAllowDownload" style="display: none">
							<% String alertMsg = "alert('Use Mozilla Firefox to download the installer.');"; %> <a href="#"
								onclick="<%= alertMsg %>" class="rounded {transparent} button" tabindex="3"> <netui:content
								value="${bundle.web['installClient.windows.buttonText']}" /> </a></div>
							Use <a href="<netui-template:attribute name="helpLinkLinux"/>" onClick="return showHelpWindow(this.href);">root
							/ sudo access</a> to install.</td>
                    ...
                    %>
                          ...
                          <%} %>
							<td class="transparent-top" width="5%"><img class="transparent"
								src="../resources/images/legacy/icon_linux.png" /></td>
							<td class="transparent-top" width="40%"><b><netui:content
								value="${bundle.web['installClient.linux.clientName2']}" /></b><br>
							<i><netui:content value="${bundle.web['installClient.linux.OS']}" /></i><br>
							<div id="allowDownload2" style="display: none"><a href="#" onclick="<%= href_RUNLINUX %>"
								class="rounded {transparent} button" tabindex="3"> <netui:content
								value="${bundle.web['installClient.windows.buttonText2']}" /> </a></div>
							<div id="notAllowDownload2" style="display: none">
							<% String alertMsg2 = "alert('Use Mozilla Firefox to download the installer.');"; %> <a href="#"
								onclick="<%= alertMsg2 %>" class="rounded {transparent} button" tabindex="3"> <netui:content
								value="${bundle.web['installClient.windows.buttonText2']}" /> </a></div>
							</td>
							<%} %>
						</tr>
