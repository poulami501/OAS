					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<table width="100%" border="0">
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="4">
										...
										<tr class="transparent">
											<td class="transparent">Grade :</td>
											<td><select name="grade" id="grade" class="norBox">
											</select></td>
										</tr>
										<tr class="transparent">
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											...
											<table width="100%" cellpadding="2" cellspacing="1" class="shadowBorder">
												...
												<tr>
													<td height="20" align="center" bgcolor="#FFFFFF" class="transparent"><input name="radiobutton"
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td width="31" height="20" align="left" valign="middle"><input type="checkbox" id="testBreak" value="1"
										onClick="toggleAccessCode();" class="norBox" checked="checked" /></td>
									<td width="864" class="transparent">Allow Test Breaks <input name="textfield8" type="text" class="textbox"
										id="aCode" value="WORM121323" style="display: none;" /></td>
								</tr>
								<tr>
									<td height="10" colspan="2"></td>
								</tr>
								<tr>
									...
									<table width="100%" cellpadding="2" cellspacing="1" class="shadowBorder">
										<tr class="subtestHeader">
											...
											<div align="center" id="aCodeH"><strong>Access Code </strong></div>
											</th>
											<th width="73" height="20" align="center"><strong>Duration</strong></th>
											<th width="34" height="20">&nbsp;</th>
										</tr>
										<tr>
											<td height="20" class="transparent">
											<div align="center" id="text11">1</div>
											</td>
											<td height="20" class="transparent">
											<div align="left" id="text12">Locator Test - Las Links Form A Level L</div>
											</td>
											<td height="20" class="transparent">
											<div align="center" id="aCodeB1"><input name="textfield" type="text" class="textbox" id="text14"
												value="WORM121323" /></div>
											</td>
											<td height="20" class="transparent">
											<div align="center" id="text13">10</div>
											</td>
											<td height="20" class="transparent">
											<div align="center"><img id="imgM1" src="images/minus.gif" width="14" title="Remove"
												onclick="toggleRows('0','1');" /> <img id="imgP1" src="images/icone_plus.gif" width="14" title="Add"
												onclick="toggleRows('1','1');" style="display: none;" /></div>
											</td>
										</tr>
										<tr>
											<td height="20">
											<div align="center" id="text21">2</div>
											</td>
											<td height="20">
											<div align="left" id="text22">Listening</div>
											</td>
											<td height="20">
											<div align="center" id="aCodeB2"><input name="textfield2" type="text" class="textbox" id="text24"
												value="HANDFUL10" /></div>
											</td>
											<td height="20">
											<div align="center" id="text23">15</div>
											</td>
											<td height="20">
											<div align="center"><img id="imgM2" src="images/minus.gif" width="14" title="Remove"
												onclick="toggleRows('0','2');" /> <img id="imgP2" src="images/icone_plus.gif" width="14" title="Add"
												onclick="toggleRows('1','2');" style="display: none;" /></div>
											</td>
										</tr>
										<tr>
											<td height="20" class="transparent">
											<div align="center" id="text11">3</div>
											</td>
											<td height="20" class="transparent">
											<div align="left" id="text12">Locator Test - Las Links Form A Level L</div>
											</td>
										...
										<tr>
											<td height="20">
											<div align="center" id="text21">4</div>
											</td>
											<td height="20">
											<div align="left" id="text22">Listening</div>
											</td>
										...
										<tr>
											<td height="20" class="transparent">
											<div align="center" id="text11">5</div>
											</td>
											<td height="20" class="transparent">
											<div align="left" id="text12">Locator Test - Las Links Form A Level L</div>
											</td>
										...
										<tr>
											<td height="20">
											<div align="center" id="text21">6</div>
											</td>
											<td height="20">
											<div align="left" id="text22">Listening</div>
											</td>
