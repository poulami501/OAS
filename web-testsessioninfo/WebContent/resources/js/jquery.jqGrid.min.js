                ...
                if (this.tagName.toUpperCase() != "TABLE") alert("Element is not a table");
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(a.jgrid.errors.model);
                        ...
                        l = function (u, t) {
                            ...
                            W = u + "_center";
                            J = u + "_right";
                            a("#" + a.jgrid.jqID(u)).append("<div id='" + P + "' class='ui-pager-control zIndex' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='" + I + "' align='left'></td><td id='" + W + "' align='center' style='white-space:pre;'></td><td id='" + J + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr");
                            ...
                            if (j == "rtl") z += D;
                            if (b.p.pginput === true) w = "<td dir='" + j + "' style='width:110px;'>" + a.jgrid.format(b.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + a.jgrid.jqID(u) + "' style='width:75px;'></span>") + "</td>";
                        ...
                        var qa = function (u, t, w, z) {
                                if (b.p.colModel[t].sortable) if (!(b.p.savedRow.length > 0)) {
                                    ...
                                    w = b.p.sortorder;
                                    if (a.isFunction(b.p.onSortCol)) 
                                    
                                    if (b.p.onSortCol.call(b, u, t, w) == "stop") {
                                    	alert("entered");
                                        b.p.lastsort = t;
                                        return
                                    }
                        ...
                        a(g.bDiv).append(a('<div style="position:relative; background:#FFFFFF;' + (n && a.browser.version < 8 ? "height:0.01%;" : "") + '"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({
                            height: b.p.height + 70 + (isNaN(b.p.height) ? "" : "px"),
                            width: g.width + "px"
                        }).scroll(g.scrollGrid);
    ...
    a.extend(a.jgrid, {
        ...
        createEl: function (d, e, c, f, g) {
            ...
            case "tree":
                ...
                f = [];
                 ...
                 a.ajax(a.extend({
                    ...
                    success:	function(data, textStatus, XMLHttpRequest){	
			                            ...
			                            j(b, e);
			                           // createMultiNodeSelectedTree (data);
			                           jsond = data;
			                           var y = "<table><tr><td><input  class='FormElement ui-widget-content ui-corner-all' type='text'  role='textbox'></td><td><a href='javascript:void(0)' id='selectOrg' class='fm-button ui-state-default ui-corner-left'><span class='class='ui-icon ui-icon-triangle-1-e'></span></a></td></tr></table>";
			                           b.append(y);
			                            e = h(b, e);
                ...
                //else if (e.value) {
                    // when selected node to be added
               // }
            	break;
            	 case "newtree":
            	b = document.createElement("div");
                b.setAttribute("role", "tree");
                 j(b, e);
			     var y = "<table><tr><td><input  class='FormElement ui-widget-content ui-corner-all' type='text'  role='textbox'></td><td><a href='javascript:populateTreeSelect()' id='selectOrg' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a></td></tr></table>";
			      a(b).append(y);
			      e = h(b, e);
			  	break;
            case "textarea":
                ...
                function g(E, H, U, M) {
                    ...
                    a(H.p.colModel).each(function (wa) {
                        ...
                        if (Q !== "cb" && Q !== "subgrid" && this.editable === true && Q !== "rn") {
                            ...
                            if (V === "" && this.edittype == "checkbox")
                             V = a(fa).attr("offval");
                            if (V === "" && this.edittype == "select") 
                            V = a("option:eq(0)", fa).text();
                            if (V === "" && this.edittype == "tree")
                             V = a("option:eq(0)", fa).text();
                            if (c.checkOnSubmit || c.checkOnUpdate) c._savedData[Q] = V;
                            a(fa).addClass("FormElement");
                            if (this.edittype == "text" || this.edittype == "textarea") 
                            a(fa).addClass("ui-widget-content ui-corner-all");
                        ...
                        for (n = 0; n < l; n++) {
                            ...
                            if (e.add) {
                                ...
                                a(k, p).attr({
                                    ...
                                    a(this).hasClass("ui-state-disabled") || (a.isFunction(e.addfunc) ?
                                     e.addfunc() :
                            ...
                            if (e.edit) {
                                ...
                                a(k, p).attr({
                                    ...
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        var q = m.p.selrow;
                                        if (q) a.isFunction(e.editfunc) ? 
                                        e.editfunc(q) :
                                       a(m).jqGrid("editGridRow", q, c);
                                        else {
                                 ...
                                 //   createMultiNodeSelectedTree (jsond);
                                    return false
                                }).hover(function () {
                                    a(this).hasClass("ui-state-disabled") || a(this).addClass("ui-state-hover")
                                }, function () {
            ...
            return this.each(function () {
                if (this.grid) {
                    ...
                    if (c) if (!(e.id && a("#" + e.id, c).html() !== null)) {
                        ...
                        else if(e.position == "one-before-last") c.rows[0].cells.length === 0 ? a("tr", c).append(g) : a("tr td:last", c).before(g); 
            ...
            return this.each(function () {
                if (this.grid) {
                    ...
                    if (c) {
                        ...
                        if(e.position == "first"){
                        	c.rows[0].cells.length === 0 ? a("tr", c).append(f) : a("tr td:eq(0)", c).before(f);
                        }else {
                        	 a("tr", c).append(f);
                        }
