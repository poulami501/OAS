            ...
            <ctb:tableFilter dataSource="actionForm.filterVisible" >
                ...
                <tr class="tableFilter">
                    <td class="tableFilter alignRight" colspan="6">
                        <netui:button styleClass="button" value="${bundle.widgets['button.apply']}" type="submit" onClick="setElementValueAndSubmitWithAnchor('{actionForm.currentAction}', 'applyFilters', 'programStatusAnchor', this); return false;" />&nbsp;
