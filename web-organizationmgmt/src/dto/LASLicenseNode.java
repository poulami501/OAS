...
import com.ctb.util.LASDateUtils;
...
{ 
	 static final long serialVersionUID = 1L;
		...
		public String getExpiryStatus() {
	        Date expDate = LASDateUtils.getDateFromDateShortString(this.expiryDate);
	        Date today = new Date();
	...
	//System.out.println("today60 = " + today60.toString());
	        ...
	        if (LASDateUtils.isBeforeToday(expDate, TimeZone.getDefault().getID())) {
		...
		public CustomerLicense makeCopy() 
		{
	         ...
	         copied.setLicenseperiodStartdate(LASDateUtils.getDateFromDateShortString(this.purchaseDate));
	         copied.setLicenseperiodEnd(LASDateUtils.getDateFromDateShortString(this.expiryDate));
