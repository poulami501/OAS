...
public class CTBTag extends TagSupport {
	...
	protected void displayOrgTableStart() throws IOException {
		StringBuffer buff = new StringBuffer();
		buff.append("<table id=\"orgTable\" class=\"transparent\" >");
		writeToPage(buff.toString());	
	}
	...
	protected void displayOrgRowStart(String id_, String style_) throws IOException {
		StringBuffer buff = new StringBuffer();
		buff.append("<tr class=\"transparent\"");
		if (id_ != null) {
			buff.append(" id=\"" + id_ + "\"");
		}
		if (style_ != null) {
	...
	protected void displayCellStartColspanHeight(String class_, String colspan_, String height_) throws IOException {
		StringBuffer buff = new StringBuffer();
		buff.append("<td");
		if(class_ != null)
			buff.append(" class=\"" + class_ + "\"");
	...
	protected void displayCellHeaderStart(String class_, String width_, String height_) throws IOException {
		StringBuffer buff = new StringBuffer();
		buff.append("<th");
		if(class_ != null)
			buff.append(" class=\"" + class_ + "\"");
	...
	protected void displayCellHeaderEnd() throws IOException {
		writeToPage("</th>");
	}
