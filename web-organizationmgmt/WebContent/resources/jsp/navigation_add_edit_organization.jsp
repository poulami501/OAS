...
<div id="legacyNav">
    ...
    <tr>
        <td>
            ...
            <tr>
                <td><netui:anchor action="homepage" onclick="return verifyExitAddOrganization();">home</netui:anchor></td>
                <c:if test="${ sessionScope.userHasReports}">                
                <td>| <a href="/TestSessionInfoWeb/homepage/viewReports.do" onclick="return verifyExitAddOrganization();">reports</a></td>
                </c:if>
                <td>| <a href="/UserManagementWeb/manageUser/beginMyProfile.do" onclick="return verifyExitAddOrganization();">my profile</a></td>
                <ctb:auth roles="Administrator">
                    <td>| <a href="/OrganizationManagementWeb/administration/begin.do" onclick="return verifyExitAddOrganization();">system administration</a></td>
                </ctb:auth>
            </tr>
            </table>
        </td>
