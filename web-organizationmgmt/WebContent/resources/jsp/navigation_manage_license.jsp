...
<div id="legacyNav">
    ...
    <tr>
        <td>
            ...
            <tr>
                <td><netui:anchor action="homepage" onClick="return verifyCancelLicenses();" >home</netui:anchor></td>
                <c:if test="${ sessionScope.userHasReports}">                
                <td>| <a href="/TestSessionInfoWeb/homepage/viewReports.do" onClick="return verifyCancelLicenses();"  >reports</a></td>
                </c:if>
                <td>| <a href="/UserManagementWeb/manageUser/beginMyProfile.do" onClick="return verifyCancelLicenses();"  >my profile</a></td>
                <ctb:auth roles="Administrator">
                    <td>| <a href="/OrganizationManagementWeb/administration/begin.do" onClick="return verifyCancelLicenses();" >system administration</a></td>
                </ctb:auth>
            </tr>
            </table>
        </td>
