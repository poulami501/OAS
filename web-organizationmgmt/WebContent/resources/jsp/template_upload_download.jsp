...
<netui:html>
  <head>
    ...
    <link href="<%=request.getContextPath()%>/resources/css/progress_modal.css" type="text/css" rel="stylesheet" />
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/progress_modal.js"></script>
  </head>
