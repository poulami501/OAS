...
<div id="legacyNav">
    ...
    <tr>
        <td>
            ...
            <tr>
                <td><netui:anchor action="homepage" onclick="return verifyExitReopenTestSession();">home</netui:anchor></td>
                <c:if test="${ sessionScope.userHasReports}">                
                <td>| <a href="/TestSessionInfoWeb/homepage/viewReports.do" onclick="return verifyExitReopenTestSession();">reports</a></td>
                </c:if>
                <td>| <a href="/UserManagementWeb/manageUser/beginMyProfile.do" onclick="return verifyExitReopenTestSession();">my profile</a></td>
                <ctb:auth roles="Administrator">
                    <td>| <a href="/OrganizationManagementWeb/administration/begin.do" onclick="return verifyExitReopenTestSession();">system administration</a></td>
                </ctb:auth>
            </tr>
            </table>
        </td>
