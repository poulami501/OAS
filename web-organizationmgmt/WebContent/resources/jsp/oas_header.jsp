		...
		<table style="margin-left:40px;">       
		   <% 
            ...
            <tr>
                <td><h4>
	                <li style="list-style-type: square;">
	                	<a onclick="showLoading();" href="<%=request.getContextPath()%>/orgOperation/switchToLinkSelected.do?selectedLink=EOI_Link">Manage the Oklahoma EOI online test administration</a>
	                </li>
                </h4></td>
            </tr>
            <% } else { %>
            <tr>
	            <td><h4>
	                <li style="list-style-type: square;">
	                	<a onclick="showLoading();" href="<%=request.getContextPath()%>/orgOperation/switchToLinkSelected.do?selectedLink=3-8_Link">Manage the Oklahoma 6-8 online test administration</a>
	                </li>
	            </h4></td>
            </tr>
            <% } %>
            ...
            <tr>
                <td><h4>
                <li style="list-style-type: square;">	
                	<a onclick="showLoading();" href="<%=request.getContextPath()%>/orgOperation/switchToLinkSelected.do?selectedLink=UserLink">Manage user accounts (shared between EOI and 6-8)</a>
                </li>
            	</h4></td>
            </tr>
            </ctb:auth>
