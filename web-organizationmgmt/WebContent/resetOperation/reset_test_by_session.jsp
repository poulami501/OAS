				...
				<c:if test="${sessionScope.hasAuditingResetTestSession}">
					<tr>
						<td align="left" style="padding-bottom: 5px; padding-top: 5px;">
							<input type="radio" id = "wipeOutBySession1" name = "wipeOutBySession" value="systemStop" align="left" checked="checked" onchange="setWipeOut(false);"> <lb:label key="reset.test.system.stop.message" /> 
							<br>
							<input type="radio" id = "wipeOutBySession2" name = "wipeOutBySession" value="wipeOut" align="left" onchange="setWipeOut(true);"> <lb:label key="reset.test.schedule.messsage" /> 
						</td>
					</tr>
				</c:if>
				<tr>
									...
									<tr class="transparent">
										...
										<td  class="transparent" rowspan="3" width="*" valign="top">
											<textarea onkeypress="return blockEventOnMaxLength(this,255)" onkeyup="checkAndTruncate(this,255)" 
												onblur="return checkAndTruncate(this,255)" style="font-family: Arial; font-size: 10pt; width: 800px;" tabindex="5" cols="60" rows="3" id="reset_by_session_request_description" name="resetBySessionRequestDescription"></textarea>
										</td>
									</tr>
