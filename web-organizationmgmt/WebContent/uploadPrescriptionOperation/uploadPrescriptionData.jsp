...
<lb:bundle baseName="prescriptionApplicationResource" />
...
<netui:form action="managePrescriptionUpload" enctype="multipart/form-data" method="post">
<input type="hidden" id="menuId" name="menuId" value="uploadPrescriptionDataLink" />
...
<table width="97%" style="margin:15px auto;" border="0"> 
	...
	<tr>  
		<td style="padding-left:6px;">
			<div id="uploadData" style="float:left; width:1275px; background-color: #FFFFFF; overflow-y: hidden !important; overflow-x: hidden !important;">
				...
				<script>populateDownloadPrescriptionTemplateListGrid();</script>
			</div>								
		</td>
	</tr>
	<tr><td>&nbsp;</td></tr>	
	...
	<tr> 
		<td style="padding-left:6px;">
            ...
            &nbsp;
        	<a href="#" id="upload" onclick="return uploadPrescriptionFile(this);" class="rounded {transparent} buttonDisabled" style="text-decoration: none;" >
...
$(document).ready(function(){
	setMenuActive("services", "uploadPrescriptionDataLink");
});
</script>
