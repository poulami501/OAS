...
<table class="sortable">
	...
	<tr class="sortable">
		...
		<table class="tableFilter">
			<tr class="tableFilter">
				...
				<td class="tableFilter" width="*"><netui:textBox tagId="servicingRequestId" dataSource="actionForm.ticketID"
					tabindex="1" /></td>
			...
			<tr class="tableFilter">
				...
				<td class="tableFilter" width="*"><netui:textBox tagId="Requestor" dataSource="actionForm.serviceRequestor"
					tabindex="5" /></td>
	...
	<netui-data:repeaterItem>
		<tr class="sortable">
			...
			<td class="sortable"><netui:span value="${container.item.subtestStatus}" /></td>
			<td class="sortable"><netui:span value="${container.item.startDate}" /></td>
			<td class="sortable"><netui:span value="${container.item.completionDate}" /></td>
			<td class="sortable"><netui:span value="${container.item.itemsAnswered}" /></td>
	...
	<netui-data:repeaterFooter>
		...
		<tr class="sortable">
			<td class="sortableControls" colspan="7"><ctb:tablePager dataSource="actionForm.subtestDetailsPageRequested"
				summary="request.subtestDetailsPagerSummary" objectLabel="${bundle.oas['object.students']}" foundLabel="Found"
				id="subtestDetailsSearchResult" anchorName="subtestDetailsSearchResult" /></td>
		</tr>
