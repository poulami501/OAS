...
<netui-template:setAttribute name="title" value="${bundle.web['editorg.window.title']}"/>
<netui-template:setAttribute name="helpLink" value="${bundle.help['help.topic.editOrganization']}"/>
...
<netui:hidden dataSource="actionForm.selectedOrgNodeType"/> 
<netui:hidden dataSource="actionForm.tempOrgChildNodeId"/> 
<netui:hidden dataSource="actionForm.actionPermission"/> 
...
<netui-data:repeater dataSource="requestScope.orgNodes">
    ...
    <tr class="sortable">
        <ctb:tableSortColumnGroup columnDataSource="actionForm.orgListSortColumn" orderByDataSource="actionForm.orgListSortOrderBy" >
