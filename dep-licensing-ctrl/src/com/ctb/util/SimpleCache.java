...
public class SimpleCache {
	...
	public static void cacheResult(String cacheType, String cacheArg, Object result, String userId) {
		...
		if(userCacheMap == null) {
			...
			OASLogger.getLogger("TestLicense").debug("SimpleCache.cacheResult: new cache size (users): " + cacheMap.size());
		}
	...
	public static void clearUserCache(String userId) {
		...
		OASLogger.getLogger("TestLicense").debug("SimpleCache.clearUserCache: new cache size (users): " + cacheMap.size());
	}
