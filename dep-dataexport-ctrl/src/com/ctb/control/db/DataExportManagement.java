...
{ 
   ...
   */
    ...
    @JdbcControl.SQL(statement = " select count (distinct roster.test_roster_id) as toatalCount from test_roster roster, student_item_set_status sis where roster.customer_id = {customerId} and roster.test_admin_id = {testAdminId} and roster.test_completion_status = 'IC' and sis.test_roster_id = roster.test_roster_id and sis.completion_status = 'IN'" , arrayMaxLength=0, fetchSize = 50000) 
