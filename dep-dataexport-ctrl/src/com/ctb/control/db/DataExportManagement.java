...
{ 
   ...
   */
    ...
    @JdbcControl.SQL(statement = " select jobId, studentCount, to_char(createdDateTime, 'MM/DD/YYYY') as createdDateTime, jobStatus, createdBy, lastUpdateTime, lastUpdateStatus, message from (   select distinct export.export_id as jobId, export.student_count as studentCount, export.created_date_time as createdDateTime, status.status_name as jobStatus, export.created_by as createdBy, export.last_update_time as lastUpdateTime, export.last_update_status as lastUpdateStatus, export.message as message from data_export export, job_status status where export.status = status.status_id and export.created_by = {userId} ORDER by export.created_date_time desc)" , arrayMaxLength=0, fetchSize = 50000) 
	ManageJob[] getDataExportJobStatus(Integer userId)throws SQLException;
    
    @JdbcControl.SQL(statement = " SELECT testAdminId, testSessionName, startDate, endDate, to_char(startDate, 'MM/DD/YY') as startDateString, to_char(endDate, 'MM/DD/YY') as endDateString, status, dailyLoginStartTime, dailyLoginEndTime, timeZone FROM (select DISTINCT tadmin.test_admin_id as testAdminId, tadmin.test_admin_name as testSessionName, tadmin.login_start_date as startDate, tadmin.login_end_date as endDate, tadmin.test_admin_status as status, tadmin.daily_login_start_time as dailyLoginStartTime, tadmin.daily_login_end_time as dailyLoginEndTime, tadmin.time_zone as timeZone from test_admin tadmin, program prog where tadmin.login_start_date BETWEEN prog.program_start_date and prog.program_end_date and tadmin.login_end_date BETWEEN prog.program_start_date and prog.program_end_date and tadmin.program_id = prog.program_id and prog.activation_status = 'AC' and prog.customer_id = {customerId}   ORDER BY tadmin.test_admin_name)" , arrayMaxLength=0, fetchSize = 50000) 
    ManageTestSession[] getTestSessionForExportWithStudents(Integer customerId)throws SQLException;
    
    @JdbcControl.SQL(statement = " SELECT testAdminId, testSessionName, startDate, endDate, to_char(startDate, 'MM/DD/YY') as startDateString, to_char(endDate, 'MM/DD/YY') as endDateString, status, dailyLoginStartTime, dailyLoginEndTime, timeZone FROM (select DISTINCT tadmin.test_admin_id as testAdminId, tadmin.test_admin_name as testSessionName, tadmin.login_start_date as startDate, tadmin.login_end_date as endDate, tadmin.test_admin_status as status, tadmin.daily_login_start_time as dailyLoginStartTime, tadmin.daily_login_end_time as dailyLoginEndTime, tadmin.time_zone as timeZone from test_admin tadmin, program prog, users u, user_role ur, org_node_ancestor ona  where tadmin.login_start_date BETWEEN prog.program_start_date and prog.program_end_date and tadmin.login_end_date BETWEEN prog.program_start_date and prog.program_end_date and tadmin.program_id = prog.program_id and prog.activation_status = 'AC' and prog.customer_id = {customerId} and tadmin.creator_org_node_id = ona.org_node_id  and ona.ancestor_org_node_id = ur.org_node_id and ur.user_id = u.user_id  and u.user_name = {userName}  ORDER BY tadmin.test_admin_name)" , arrayMaxLength=0, fetchSize = 50000) 
    ManageTestSession[] getTestSessionForExportWithStudentsForUser(Integer customerId, String userName)throws SQLException;

    //@JdbcControl.SQL(statement = " SELECT testAdminId, testSessionName, startDate, endDate, to_char(startDate, 'MM/DD/YY') as startDateString, to_char(endDate, 'MM/DD/YY') as endDateString, status, dailyLoginStartTime, dailyLoginEndTime, timeZone FROM (select DISTINCT tadmin.test_admin_id as testAdminId, tadmin.test_admin_name as testSessionName, tadmin.login_start_date as startDate, tadmin.login_end_date as endDate, tadmin.test_admin_status as status, tadmin.daily_login_start_time as dailyLoginStartTime, tadmin.daily_login_end_time as dailyLoginEndTime, tadmin.time_zone as timeZone from test_admin tadmin, program prog, users u, user_role ur, product prod, org_node_ancestor ona  where tadmin.login_start_date BETWEEN prog.program_start_date and prog.program_end_date and tadmin.login_end_date BETWEEN prog.program_start_date and prog.program_end_date and tadmin.program_id = prog.program_id and prog.activation_status = 'AC' and prog.customer_id = {customerId} and tadmin.creator_org_node_id = ona.org_node_id  and ona.ancestor_org_node_id = ur.org_node_id and ur.user_id = u.user_id and prod.product_id = tadmin.product_id and prod.parent_product_id = {productId} and u.user_name = {userName}  ORDER BY tadmin.test_admin_name)" , arrayMaxLength=0, fetchSize = 50000) 
    @JdbcControl.SQL(statement = " SELECT testAdminId, testSessionName, startDate, endDate, to_char(startDate, 'MM/DD/YY') as startDateString, to_char(endDate, 'MM/DD/YY') as endDateString, status, dailyLoginStartTime, dailyLoginEndTime, timeZone FROM (select DISTINCT tadmin.test_admin_id as testAdminId, tadmin.test_admin_name as testSessionName, tadmin.login_start_date as startDate, tadmin.login_end_date as endDate, tadmin.test_admin_status as status, tadmin.daily_login_start_time as dailyLoginStartTime, tadmin.daily_login_end_time as dailyLoginEndTime, tadmin.time_zone as timeZone from test_admin tadmin, program prog, users u, user_role ur, product prod, org_node_ancestor ona  where tadmin.login_start_date BETWEEN prog.program_start_date and prog.program_end_date and tadmin.login_end_date BETWEEN prog.program_start_date and prog.program_end_date and tadmin.program_id = prog.program_id and prog.activation_status = 'AC' and prog.customer_id = {customerId} and tadmin.creator_org_node_id = ona.org_node_id  and ona.ancestor_org_node_id = ur.org_node_id and ur.user_id = u.user_id and prod.product_id = tadmin.product_id and prod.parent_product_id = {productId} and prod.product_type <> 'ST' and u.user_name = {userName} and {sql: sqlQuery} ORDER BY tadmin.test_admin_name)" , arrayMaxLength=0, fetchSize = 50000)
    ManageTestSession[] getTestSessionForExportWithStudentsForUserWithFrameworkId(Integer customerId, String userName, Integer productId, String sqlQuery)throws SQLException;
    
    @JdbcControl.SQL(statement = " SELECT testAdminId, testSessionName, startDate, endDate, to_char(startDate, 'MM/DD/YY') as startDateString, to_char(endDate, 'MM/DD/YY') as endDateString, status, dailyLoginStartTime, dailyLoginEndTime, timeZone FROM (select DISTINCT tadmin.test_admin_id as testAdminId, tadmin.test_admin_name as testSessionName, tadmin.login_start_date as startDate, tadmin.login_end_date as endDate, tadmin.test_admin_status as status, tadmin.daily_login_start_time as dailyLoginStartTime, tadmin.daily_login_end_time as dailyLoginEndTime, tadmin.time_zone as timeZone from test_admin tadmin, program prog where tadmin.login_start_date BETWEEN prog.program_start_date and prog.program_end_date and tadmin.login_end_date BETWEEN prog.program_start_date and prog.program_end_date and tadmin.program_id = prog.program_id and prog.activation_status = 'AC' and prog.customer_id = {customerId}  and {sql: sessionIds} ORDER BY tadmin.test_admin_name)" , arrayMaxLength=0, fetchSize = 50000) 
    ManageTestSession[] getSelectedTestSessionDetails(Integer customerId, String sessionIds)throws SQLException;
    
    @JdbcControl.SQL(statement = " SELECT testAdminId, testSessionName, startDate, endDate, to_char(startDate, 'MM/DD/YY') as startDateString, to_char(endDate, 'MM/DD/YY') as endDateString, status, dailyLoginStartTime, dailyLoginEndTime, timeZone FROM (select DISTINCT tadmin.test_admin_id as testAdminId, tadmin.test_admin_name as testSessionName, tadmin.login_start_date as startDate, tadmin.login_end_date as endDate, tadmin.test_admin_status as status, tadmin.daily_login_start_time as dailyLoginStartTime, tadmin.daily_login_end_time as dailyLoginEndTime, tadmin.time_zone as timeZone from test_admin tadmin, program prog, users u, user_role  ur,  org_node_ancestor  ona  where tadmin.login_start_date BETWEEN prog.program_start_date and prog.program_end_date and tadmin.login_end_date BETWEEN prog.program_start_date and prog.program_end_date and tadmin.program_id = prog.program_id and prog.activation_status = 'AC' and prog.customer_id = {customerId}  and tadmin.creator_org_node_id = ona.org_node_id and ona.ancestor_org_node_id = ur.org_node_id  and ur.user_id = u.user_id  and u.user_name = {userName}  and {sql: sessionIds} ORDER BY tadmin.test_admin_name)" , arrayMaxLength=0, fetchSize = 50000) 
    ManageTestSession[] getSelectedTestSessionDetailsForUser(Integer customerId, String sessionIds, String userName)throws SQLException;
    
    //@JdbcControl.SQL(statement = " SELECT testAdminId, testSessionName, startDate, endDate, to_char(startDate, 'MM/DD/YY') as startDateString, to_char(endDate, 'MM/DD/YY') as endDateString, status, dailyLoginStartTime, dailyLoginEndTime, timeZone FROM (select DISTINCT tadmin.test_admin_id as testAdminId, tadmin.test_admin_name as testSessionName, tadmin.login_start_date as startDate, tadmin.login_end_date as endDate, tadmin.test_admin_status as status, tadmin.daily_login_start_time as dailyLoginStartTime, tadmin.daily_login_end_time as dailyLoginEndTime, tadmin.time_zone as timeZone from test_admin tadmin, program prog, users u, user_role  ur, product  prod, org_node_ancestor  ona  where tadmin.login_start_date BETWEEN prog.program_start_date and prog.program_end_date and tadmin.login_end_date BETWEEN prog.program_start_date and prog.program_end_date and tadmin.program_id = prog.program_id and prog.activation_status = 'AC' and prog.customer_id = {customerId}  and tadmin.creator_org_node_id = ona.org_node_id and ona.ancestor_org_node_id = ur.org_node_id  and ur.user_id = u.user_id  and prod.product_id = tadmin.product_id and prod.parent_product_id = {productId} and u.user_name = {userName}  and {sql: sessionIds} ORDER BY tadmin.test_admin_name)" , arrayMaxLength=0, fetchSize = 50000) 
    @JdbcControl.SQL(statement = " SELECT testAdminId, testSessionName, startDate, endDate, to_char(startDate, 'MM/DD/YY') as startDateString, to_char(endDate, 'MM/DD/YY') as endDateString, status, dailyLoginStartTime, dailyLoginEndTime, timeZone FROM (select DISTINCT tadmin.test_admin_id as testAdminId, tadmin.test_admin_name as testSessionName, tadmin.login_start_date as startDate, tadmin.login_end_date as endDate, tadmin.test_admin_status as status, tadmin.daily_login_start_time as dailyLoginStartTime, tadmin.daily_login_end_time as dailyLoginEndTime, tadmin.time_zone as timeZone from test_admin tadmin, program prog, users u, user_role  ur, product  prod, org_node_ancestor  ona  where tadmin.login_start_date BETWEEN prog.program_start_date and prog.program_end_date and tadmin.login_end_date BETWEEN prog.program_start_date and prog.program_end_date and tadmin.program_id = prog.program_id and prog.activation_status = 'AC' and prog.customer_id = {customerId}  and tadmin.creator_org_node_id = ona.org_node_id and ona.ancestor_org_node_id = ur.org_node_id  and ur.user_id = u.user_id  and prod.product_id = tadmin.product_id and prod.parent_product_id = {productId} and prod.product_type <> 'ST' and u.user_name = {userName}  and {sql: sessionIds} ORDER BY tadmin.test_admin_name)" , arrayMaxLength=0, fetchSize = 50000)
    ManageTestSession[] getSelectedTestSessionDetailsWithFrameworkId(Integer customerId, String sessionIds, String userName, Integer productId)throws SQLException;
